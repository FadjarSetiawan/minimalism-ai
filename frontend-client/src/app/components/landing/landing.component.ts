  ...
  template: `
    ...
    <section class="max-w-6xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center transition-colors duration-300">
      ...
      <div class="flex items-center justify-center relative transition-all duration-300 select-none">
        <img src="assets/images/Kecerdasan Terfokus - White.png" class="w-full max-w-[520px] h-auto object-contain dark:hidden transition-all duration-300 rounded-3xl" alt="Kecerdasan Terfokus">
        <img src="assets/images/Kecerdasan Terfokus -  Black.svg" class="w-full max-w-[520px] h-auto object-contain hidden dark:block transition-all duration-300 rounded-3xl" alt="Kecerdasan Terfokus">
      </div>
    </section>
